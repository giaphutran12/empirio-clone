...
export const cases04to12: CaseDefinition[] = [
  {
    ...
    "briefing": "It is January 2007. Your team has built a touch phone that also plays music and browses the web. You must choose a launch plan before the public reveal.",
    ...
    "options": [
      {
        ...
        "tradeoff": "A clear launch path trades off against limited network choice."
      },
      {
        "id": "open",
      ...
      },
      {
        ...
        "description": "Test typing, service and support with invited buyers first.",
        "tradeoff": "You learn from real use but give up a broad launch now."
      },
      {
        "id": "hold",
        "title": "Hold the launch",
        "description": "Keep selling current products while the phone team tests.",
    ...
    "reveal": {
      ...
      "title": "The phone without keys",
      "history": "Apple showed the iPhone in January 2007 with Cingular as its exclusive US carrier. It announced US prices of $499 and $599.",
      "lesson": "A launch needs more than a good device. Test the whole path from price to service.",
      "sources": [
        {
          "id": "s1",
      ...
      "consequences": {
        "launch": "You could get a focused launch. Plan how to reach buyers who will not switch networks.",
        "open": "You could reach more people. A deal delay may leave the product waiting.",
        "pilot": "You could find daily-use faults early. A small group may not reflect the wider market.",
  ...
  },
  {
    ...
    "briefing": "It is October 2001. Your team has a small music player ready for a launch review. The proposed price is $399. Decide whether its ease of use can earn that price.",
    ...
    "options": [
      ...
      },
      {
        ...
        "tradeoff": "You reach a clear group but learn less about stand-alone demand."
      },
      {
        "id": "hold",
    ...
    "reveal": {
      ...
      "title": "The pocket music bet",
      "history": "Apple announced the first iPod at $399 in October 2001. The offer joined a small hard-drive player with fast sync to a Mac.",
      "lesson": "A high price needs a clear gain for a clear buyer. More features alone do not prove value.",
      "sources": [
        {
          "id": "s1",
      ...
      "consequences": {
        "premium": "You could earn a premium if saved effort matters enough. Watch paid demand, not praise.",
        "lower": "You could open the door to more buyers. Check whether each sale still helps the business.",
        "bundle": "You could sell to buyers who can use it at once. Keep the bundle from hiding weak player demand.",
  ...
  },
  {
    ...
    "briefing": "It is spring 2013. Buyers can own a software version or pay for a plan with ongoing updates. The paid plan is growing. You must decide where the next new features will go.",
    ...
    "options": [
      {
        ...
        "description": "Keep the current owned version on sale; send new features to members.",
      ...
      },
      {
        ...
        "tradeoff": "Buyer choice stays broad, but the team must serve both release paths."
      },
      {
        "id": "phase",
    ...
    "reveal": {
      ...
      "title": "Rent the next release",
      "history": "In May 2013, Adobe put future creative features in Creative Cloud. It kept CS6 for sale with a perpetual license.",
      "lesson": "Growth in a paid plan is useful proof. It does not tell you how every old buyer will react.",
      "sources": [
        {
          "id": "s1",
        ...
        {
          "id": "s2",
          "title": "Adobe FY2013 10-K, historical 2012 offer and May 2013 decision",
          "url": "https://www.adobe.com/content/dam/cc/en/investor-relations/pdfs/ADBE-10K-FY13-FINAL.pdf"
        }
      ],
      "consequences": {
        "switch": "You could focus development and grow repeat fees. Explain file access and the old-version path.",
        "both": "You could retain more buyer choice. Check the cost of keeping both paths current.",
        "phase": "You could test renewal and support needs. Avoid mistaking one tool’s users for all users.",
  ...
  },
  {
    ...
    "briefing": "It is autumn 2014. You have started to open parts of your developer tools. The next choice is bigger: let outsiders help build the engine that runs server apps, and bring it to rival systems.",
    ...
    "options": [
      {
        ...
        "description": "Publish the code, accept fixes and fund work on other systems.",
      ...
      },
      {
        ...
        "description": "Leave the engine closed and continue the smaller open projects.",
    ...
    "reveal": {
      ...
      "title": "Open the engine",
      "history": "In November 2014, Microsoft announced open source for the server-side .NET stack and work to run it on Linux and Mac.",
      "lesson": "Open code is a promise to work with others. Name who owns quality and who pays for support.",
      "sources": [
        {
          "id": "s1",
  ...
  },
  {
    ...
    "briefing": "It is November 2007. After years of work, your team has a wireless reader ready for a launch review. It would cost $399. You need a plan for both the device and the books.",
    ...
    "options": [
      {
        ...
        "tradeoff": "You control the reading flow but must support hardware and content."
      },
      {
        "id": "software",
        "title": "Start with reading software",
        "description": "Offer digital books on existing computers first.",
        "tradeoff": "You avoid new hardware, but may lose the simple mobile reading flow."
      },
      {
        "id": "pilot",
        "title": "Sell a limited reader run",
        "description": "Test repeat book buying before a wider device push.",
        "tradeoff": "You reduce the first commitment but may slow publisher support."
      },
      {
        "id": "hold",
        "title": "Stay with print for now",
        "description": "Keep selling paper books while you improve the digital offer.",
        "tradeoff": "You avoid device risk but delay learning about digital habits."
      }
    ],
    "reveal": {
      "company": "Amazon",
      ...
      "title": "A bookstore in your bag",
      "history": "Amazon launched Kindle in November 2007 at $399, with wireless delivery and a digital book store.",
      "lesson": "The device is one part of the deal. Content, service and repeat use must work together.",
      "sources": [
        {
          "id": "s1",
      ...
      "consequences": {
        "device": "You could make buying and reading simple. Track repeat book purchases and support costs.",
        "software": "You could test digital demand cheaply. Computer reading may not test the pocket reader’s value.",
        "pilot": "You could learn the cost and use pattern. A small catalog or group could skew the result.",
  ...
  },
  {
    ...
    "briefing": "It is February 2005. Your team proposes a yearly fee for unlimited fast shipping. Buyers could place small orders without waiting to fill a basket. You must weigh that ease against delivery costs.",
    ...
    "options": [
      {
        ...
        "tradeoff": "A simple promise may change habits, but heavy use can be costly."
      },
      {
        "id": "minimum",
        "title": "Add an order minimum",
        "description": "Use a yearly fee but require larger baskets for included shipping.",
        "tradeoff": "Costs may fall, but the offer removes less shopping friction."
      },
      {
        "id": "pilot",
        "title": "Test with a limited group",
        "description": "Measure orders, item profit and delivery costs before widening access.",
      ...
      },
      {
        ...
        "tradeoff": "You keep known charges but leave the repeat-order idea untested."
      }
    ],
    "reveal": {
      "company": "Amazon",
      ...
      "title": "One fee, many boxes",
      "history": "Amazon introduced Prime in February 2005 for $79 a year. It offered unlimited two-day shipping without a purchase minimum.",
      "lesson": "A flat fee hides a range of costs. Watch who joins and what they do after joining.",
      "sources": [
        {
          "id": "s1",
      ...
      "consequences": {
        "unlimited": "You could make your store the easy default. Monitor profit after shipping for light and heavy users.",
        "minimum": "You could limit small-order costs. Test whether the fee still feels worth paying.",
        "pilot": "You could learn from real shipping bills. Make sure the group includes heavy users.",
  ...
  },
  {
    ...
    "briefing": "It is early May 2020. Travel has stalled. You have raised cash and cut spending, but the year still looks grim. You must decide what work the firm can keep and what that means for staff.",
    ...
    "options": [
      {
        ...
        "tradeoff": "You gain focus but lose people and the option to restart quickly."
      },
      {
        "id": "across",
      ...
      },
      {
        ...
        "tradeoff": "You avoid cuts now but risk using the cash before travel returns."
      }
    ],
    "reveal": {
      "company": "Airbnb",
      ...
      "title": "When travel stops",
      "history": "Airbnb announced nearly 1,900 job cuts in May 2020 and narrowed its focus. Chesky’s staff note explained the plan and support for people leaving.",
      "lesson": "Choose the work a smaller firm needs. Be clear and humane with the people affected.",
      "sources": [
        {
          "id": "s1",
      ...
      "consequences": {
        "focus": "You could preserve the core service. Explain why each line of work stays or ends.",
        "across": "You could spread pain evenly. Equal cuts may not match what the business needs.",
        "temporary": "You could keep scarce skills. Get consent and check whether savings last long enough.",
  ...
  },
  {
    ...
    "briefing": "It is fall 2008. Your home-stay site has had bursts of use but no steady growth. Cash is tight. A cofounder suggests selling election-themed cereal boxes to keep the team going.",
    ...
    "options": [
      {
        ...
        "description": "Make a small batch and use paid demand to decide whether to do more.",
        "tradeoff": "It could bring cash, but is a detour from bookings."
      },
      {
        "id": "core",
        "title": "Put all effort into stays",
        "description": "Seek hosts and guests who can pay for the core service now.",
        "tradeoff": "You test the real business while the cash problem stays urgent."
      },
      {
        "id": "fundraise",
    ...
    "reveal": {
      ...
      "title": "Breakfast to buy time",
      "history": "Airbnb’s founders sold election-themed cereal in 2008. Cofounder Nathan Blecharczyk later said the sale brought $30,000 to help pay down debt. It did not solve the core growth problem.",
      "lesson": "A side sale can buy time. Decide in advance what that time will prove about the main idea.",
      "sources": [
        {
          "id": "s1",
          "title": "Nathan Blecharczyk firsthand fireside chat report, May 24, 2021",
          "url": "https://polsky.uchicago.edu/2021/05/24/fireside-chat-polsky-airbnb-cofounder-nathan-blecharczyk/"
        }
      ],
      "consequences": {
        "bridge": "You might gain cash and attention. Cap the time and keep a real booking test on the calendar.",
        "core": "You learn whether guests value the core offer. Watch debt while you learn.",
        "fundraise": "You might gain more time to build. Do not count an investor talk as money received.",
  ...
  },
  {
    ...
    "briefing": "It is early 2013. Your online game has closed. A small team remains with cash and an internal chat tool. You must decide whether to turn that tool into a business or stop.",
    ...
    "options": [
      {
        ...
        "tradeoff": "You get a fresh path but must learn a new customer and sales process."
      },
      {
        "id": "test",
        "title": "Run a bounded outside trial",
        "description": "Test setup, repeat use and willingness to pay before a full rebuild.",
      ...
      },
      {
        ...
        "tradeoff": "You avoid another loss but give up the chance to test the tool."
      }
    ],
    "reveal": {
      "company": "Slack",
      ...
      "title": "The tool left after the game",
      "history": "Tiny Speck moved from Glitch to team chat software. The product became Slack, which formally launched in 2014.",
      "lesson": "A tool that helps your own team is a lead. Outside teams must show that it helps them too.",
      "sources": [
        {
          "id": "s1",
          "title": "Board member John O’Farrell’s firsthand account, June 20, 2019",
      ...
      "consequences": {
        "pivot": "You could put a strong team behind a new need. Set milestones before spending the remaining cash.",
