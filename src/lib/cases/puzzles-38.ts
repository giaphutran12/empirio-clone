...
export const puzzleCases38: CaseDefinition[] = [
  {
    ...
    briefing:
      "Your software has 100 paying customers. A partner says a cheap annual plan will fill the bank now. You must still serve those customers all year. Decide the offer for their next renewal.",
    ...
    options: [
      {
        ...
        description:
          "Replace monthly billing with the deeply discounted offer.",
    ...
    reveal: {
      ...
      history:
        "This is an authored business puzzle. The numbers are scenario inputs, not a real company’s results.",
  ...
  },
  {
    ...
    briefing:
      "Your marketplace handles $100,000 in orders each month. An ad agency wants to double that number. Most of that money belongs to sellers, so you need to check what the platform keeps.",
  ...
  },
  {
    ...
    briefing:
      "Your online store sells custom-fit items. Sales look strong, but returned items cannot be sold again. Choose next month’s plan before placing a new stock order.",
    ...
    reveal: {
      ...
      consequences: {
        guide:
          "At the vendor’s target, the first month leaves just $300 after all stated costs. A small miss can erase that.",
        repeat:
          "After 40 refunds, only $6,000 of sales remains. Stock, delivery, returns and fixed bills cost $7,400.",
        pause:
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        description:
          "Buy 20 more hours for $600 and fill them with basic orders.",
        tradeoff:
    ...
    reveal: {
      ...
      consequences: {
        premium:
          "Premium leaves $80 per item but uses three hours. Basic leaves $40 in just one hour.",
        split:
          "The mix leaves $1,000 after fixed costs. Sixty basic items leave $1,400 using the same hours.",
        basic:
          "Basic earns $40 per machine hour versus about $26.67 for premium. Normal hours leave $1,400.",
        overtime:
          "At the stated $600 overtime price, 80 basic items leave $1,600. That is $200 more than normal hours.",
      },
      rubric: [
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        description:
          "Keep your crew and add the agency crew for another four jobs.",
      ...
      },
      {
        ...
        description:
          "Group the work so more of the paid day is spent cleaning.",
    ...
    reveal: {
      ...
      consequences: {
        scattered:
          "Four jobs leave $60 after the crew, supplies and fixed bills. The price is higher, but travel uses half the day.",
        discount:
          "Six $70 jobs leave $60, the same as the current route. You do more jobs without keeping more money.",
        second:
          "Two routes bring $800 but cost $760. That leaves less than the single current route.",
        dense:
          "Six $80 jobs leave $120 after all stated costs. Less travel makes the lower-priced jobs pay better.",
      },
      rubric: [
  ...
  },
  {
    ...
    briefing:
      "Your rental shop owns eight tools. A seller says buying eight more will double your sales. But most tools sit unused most days. Decide where to spend next month’s money.",
