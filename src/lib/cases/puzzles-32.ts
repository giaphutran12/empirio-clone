...
export const puzzleCases32: CaseDefinition[] = [
  {
    ...
    briefing:
      "You sell 100 coffees a day at $5 each. A promotion promises 50% more cups if you cut the price to $4. Your team wants a yes today. All figures are US dollars.",
    ...
    reveal: {
      ...
      consequences: {
        discount:
          "At 150 cups you keep the same $100 after costs as 100 full-price cups. More work buys no extra earnings.",
  ...
  },
  {
    ...
    briefing:
      "A company wants 300 pastries at $2 each tomorrow. That is a $600 order. Your small oven is already busy. All figures are US dollars.",
    ...
    reveal: {
      ...
      consequences: {
        ...
        partial:
          "There are 100 spare slots after 400 regular sales. Filling them can add money without losing regular orders.",
        decline:
  ...
  },
  {
    ...
    briefing:
      "A delivery app offers 40 extra meals a night. It takes 30% of each sale. Your kitchen has room, but each order needs packaging too. All figures are US dollars.",
    ...
    reveal: {
      ...
      consequences: {
        ...
        discount:
          "A $15 app meal leaves just $0.50 after the $4.50 fee, $8 meal cost and $2 packing.",
      },
      rubric: [
  ...
  },
  {
    ...
    briefing:
      "Your shop wants to remove its $5 shipping charge. A marketer predicts more orders. You also have a second idea: free shipping only on larger baskets. All figures are US dollars.",
  ...
  },
  {
    ...
    briefing:
      "A client offers a $30,000 project. The work takes one month, but the invoice is paid at the end of month three. Your bank account cannot wait that long. All figures are US dollars.",
    ...
    reveal: {
      ...
      consequences: {
        ...
        decline:
          "Without new funding or earlier payment, you cannot cover the delivery bill. Passing protects cash for other work.",
      },
      rubric: [
  ...
  },
  {
    ...
    briefing:
      "Your salon books 100 visits a week, but 20 customers do not show up. A $10 booking deposit sounds like extra income. Is that really the point? All figures are US dollars.",
    ...
    options: [
      ...
      },
      {
        ...
        description:
          "Charge a nonrefundable booking fee plus the $50 visit price.",
        tradeoff:
    ...
    reveal: {
      ...
      consequences: {
        deposit:
          "A deposit can protect a missed slot, but it does not add $10 to a completed $50 visit. Check lost bookings and fees.",
        remind:
