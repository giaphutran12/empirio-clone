...
export const puzzleCases44: CaseDefinition[] = [
  {
    ...
    "briefing": "Your ad report looks great: spend $1,000 and make $4,000 in sales. Your marketer wants to double the budget. Check what you keep after each order.",
    ...
    "evidence": [
      ...
      },
      {
        ...
        "text": "We have no evidence of future purchases. Rent and salaries are not included in these order costs.",
        "kind": "simulation",
        "sourceIds": []
      }
    ],
        ...
        "evidence": [
          {
            ...
            "text": "The quote reduces the $8 combined cost by $2 per order. It requires no setup fee.",
            "kind": "simulation",
            "sourceIds": []
          }
        ]
        ...
        "evidence": [
          {
            ...
            "text": "Ten placed one more $40 order with the same $33 order cost and no new ad bill. These returns add $70, not enough to cover the first $300 loss.",
            "kind": "simulation",
            "sourceIds": []
          }
        ]
    ...
    "event": {
      ...
      "text": "The platform now quotes $12 per order instead of $10, with no change in selling price or order costs.",
      "evidence": {
        "id": "deadline-update",
    ...
    "options": [
      ...
      },
      {
        ...
        "description": "Stop new ad spend while seeking better order costs.",
    ...
    "reveal": {
      ...
      "title": "The ad that sells at a loss",
      "history": "An authored practice case, not a historical company account. At the opening rate, $4,000 sales minus $2,500 goods, $800 delivery and fees, and $1,000 ads leaves a $300 loss before overhead.",
      "lesson": "A sale can cost more than it brings in.",
      "sources": [],
      "consequences": {
        "double": "Each order leaves $7 before ads, but ads cost $10 per order. Doubling a losing order does not fix it.",
        "pause": "The last batch lost $300 before rent and salaries. Stop paying to repeat that loss.",
        "keep": "The report shows sales, not money kept. There is no evidence yet that repeat sales cover the gap.",
        "price": "Five more dollars would cover the $3 gap per order if costs and demand held. Demand at $45 is unknown."
      },
      "rubric": [
  ...
  },
  {
    ...
    "briefing": "A chain offers a large order. It wants to pay later, while your supplier wants cash now. The order looks profitable on paper.",
    ...
    "evidence": [
      ...
      },
      {
        ...
        "text": "You must keep $4,000 untouched for existing bills. No credit line is available.",
        "kind": "simulation",
        "sourceIds": []
      },
      {
        ...
        "text": "The chain proposes paying the full $30,000 sixty days after delivery. It would account for 60% of the next quarter’s sales if accepted.",
        "kind": "simulation",
        "sourceIds": []
      }
    ],
        ...
        "evidence": [
          {
            ...
            "text": "The buyer will accept $15,000 before you order stock, with the balance sixty days after delivery. Terms need signing.",
            "kind": "simulation",
            "sourceIds": []
          }
        ]
        ...
        "evidence": [
          {
            ...
            "text": "The supplier will not extend credit for this first order. Delivery also must be prepaid.",
            "kind": "simulation",
            "sourceIds": []
          }
        ]
        ...
        "evidence": [
          {
            ...
            "text": "Two of six references report payment thirty days late. This is a small sample, not a forecast.",
            "kind": "simulation",
            "sourceIds": []
          }
        ]
    ...
    "event": {
      ...
      "text": "The buyer now caps any deposit at 20%, or $6,000. There is still no credit line.",
      "evidence": {
        "id": "deadline-update",
    ...
    "options": [
      ...
      },
      {
        ...
        "description": "Accept only after $15,000 clears, with signed balance terms.",
      ...
      },
      {
        ...
        "description": "Offer a smaller first order, subject to a fresh delivery quote.",
    ...
    "reveal": {
      ...
      "title": "The biggest customer in town",
      "history": "An authored practice case, not a historical company account. The full order leaves $10,000 before overhead if paid. Yet the opening no-deposit plan needs $12,000 more than the $8,000 you can safely spend.",
      "lesson": "Profit on paper cannot pay a bill today.",
      "sources": [],
      "consequences": {
        "accept": "You can spend only $8,000 safely. The order needs $20,000 before the buyer pays.",
        "deposit": "The deposit plus $8,000 spendable cash covers the $20,000 bill without touching the reserve.",
        "decline": "Declining avoids a cash gap and more reliance on one customer. Asking for safe terms first could preserve the opportunity.",
        "small": "Smaller goods cost less upfront, but delivery terms and buyer consent still need checking."
      },
      "rubric": [
  ...
  },
  {
    ...
    "briefing": "Tuesday seats sit empty. A half-price deal might fill them. But some buyers could move from your busy full-price shows.",
    ...
    "evidence": [
      ...
      },
      {
        ...
        "text": "The marketing team expects 40 sales, but has not checked how many would otherwise buy at $12.",
        "kind": "simulation",
        "sourceIds": []
      },
      {
        ...
        "text": "The offer can go in your own email. Rent and existing staff costs do not change. Snacks are excluded.",
        "kind": "simulation",
        "sourceIds": []
      }
    ],
        ...
        "evidence": [
          {
            ...
            "text": "Of 40 likely buyers, 10 say they would otherwise buy a regular ticket and 30 say they would not visit. These are stated plans, not paid sales.",
            "kind": "simulation",
            "sourceIds": []
          }
        ]
        ...
        "evidence": [
          {
            ...
            "text": "Your ticket system can target accounts with no purchase for six months at no added fee. This reduces, but cannot prove zero, switching.",
            "kind": "simulation",
            "sourceIds": []
          }
        ]
        ...
        "evidence": [
          {
            ...
            "text": "Nine buyers had not visited for six months. Three had bought recently. Purchase history does not prove what they would have done without the offer.",
            "kind": "simulation",
            "sourceIds": []
          }
        ]
    ...
    "event": {
      ...
      "text": "The broad email coupon would work for four weeks and can be used more than once. The system can still limit targeted codes to one use.",
      "evidence": {
        "id": "deadline-update",
    ...
    "options": [
      ...
      },
      {
        ...
        "description": "Use a small offer aimed at people who have stopped coming.",
    ...
    "reveal": {
      "company": "The cinema",
      "title": "The cheap Tuesday ticket",
      "history": "An authored practice case, not a historical company account. Forty deal tickets leave $80. If ten of those buyers would have paid full price, you give up $80 from the regular visits. The extra gain becomes zero.",
      ...
      "consequences": {
        ...
        "new": "Quiet seats cost little extra to fill. Targeting lapsed buyers lowers the risk of replacing full-price sales.",
        "regular": "You protect the $8 contribution from each regular sale. You also give up a chance to bring back guests.",
        "bundle": "A bundle could keep the ticket price intact, but you need the snack cost before deciding whether it pays."
      },
      "rubric": [
  ...
  },
  {
    ...
    "briefing": "Your supplier offers a big discount if you buy a full pallet. You sell the item steadily, but stock cannot pay the rent until it sells.",
        ...
        "evidence": [
          {
            ...
            "text": "The supplier offers 250 units now and 250 in three months at $8 each, paid on each delivery. You must commit to both batches.",
            "kind": "simulation",
            "sourceIds": []
          }
        ]
    ...
    "options": [
      ...
      },
      {
        ...
        "description": "Only accept a batch plan that keeps the bill reserve covered.",
    ...
    "reveal": {
      ...
      "title": "The bargain that empties the bank",
      "history": "An authored practice case, not a historical company account. Bulk stock saves $600 on the first 300 units sold. Yet its $4,000 upfront payment leaves only $1,000 for $2,000 of near-term bills.",
      ...
      "consequences": {
        ...
        "monthly": "This protects the bill reserve and keeps cash flexible. A discount is not useful if it stops you paying what is due.",
        "wait": "Cash stays safe, but you give up sales even though a normal order fits the budget.",
        "split": "Better payment timing could preserve the discount. Do not treat a request as agreed terms."
      },
      "rubric": [
  ...
  },
  {
    ...
    "briefing": "A client asks for a fixed price instead of your hourly rate. The work sounds simple, but the draft contract says unlimited edits.",
    ...
    "evidence": [
      ...
      },
      {
        ...
        "text": "That is your total capacity before this project’s deadline.",
        "kind": "simulation",
        "sourceIds": []
      },
      {
        ...
        "text": "For this exercise, no supplies or subcontractors are needed. Your time still has value.",
        "kind": "simulation",
        "sourceIds": []
      }
    ],
        ...
        "evidence": [
          {
            ...
            "text": "The client’s last three similar jobs required 10 to 20 extra hours. This range does not guarantee this job’s needs.",
            "kind": "simulation",
            "sourceIds": []
          }
        ]
        ...
        "evidence": [
          {
            ...
            "text": "The client will consider two named revision rounds and hourly charges for extra work, subject to written agreement.",
            "kind": "simulation",
            "sourceIds": []
          }
        ]
        ...
        "evidence": [
          {
            ...
            "text": "Another client offers ten hours at $50 per hour before the same deadline. It would use the same capacity.",
            "kind": "simulation",
            "sourceIds": []
          }
        ]
    ...
    "options": [
      ...
      },
      {
        ...
        "description": "Limit revisions in writing and quote extra work separately.",
    ...
    "reveal": {
      ...
      "title": "The flat fee with no finish line",
      "history": "An authored practice case, not a historical company account. At $1,200, 24 total hours earns $50 an hour. Thirty hours earns $40; forty hours earns $30. A higher quote does not guarantee better pay for your time.",
      "lesson": "A fixed price needs a clear finish line.",
      "sources": [],
      "consequences": {
        "unlimited": "The fee beats 20 hours at $50 only if extra work stays small. Unlimited edits leave that open.",
        "hourly": "Hourly billing pays for added work. Clear updates help the client control the bill.",
        "bounded": "A flat fee can work when both sides know what it buys and what counts as extra.",
        "decline": "You avoid an open-ended promise, but either clear scope or hourly billing may solve it."
      },
      "rubric": [
  ...
  },
  {
    ...
    "briefing": "The room has 100 seats. You have sold 60 tickets and want to confirm the venue today. Most of the room is booked, but is it enough?",
    ...
    "evidence": [
      ...
      },
      {
        ...
        "text": "No more than 100 guests fit. No sponsor or other event income is booked.",
        "kind": "simulation",
        "sourceIds": []
      },
      {
    ...
    "event": {
      ...
      "text": "The original 100-seat package now costs $2,700. Per-guest costs and ticket price stay the same. Any separately quoted smaller package is unchanged.",
      "evidence": {
        "id": "deadline-update",
    ...
    "options": [
      {
        ...
        "description": "Commit the $2,400 fixed bill for the 100-seat room.",
        "tradeoff": "Current ticket sales leave a loss."
      },
      {
        "id": "threshold",
        "title": "Require 80 paid tickets first",
        "description": "Confirm only if 80 tickets sell before the quote expires.",
    ...
    "reveal": {
      ...
      "title": "The almost sold-out workshop",
      "history": "An authored practice case, not a historical company account. At the opening quote, each $50 ticket leaves $30 after guest costs. It takes 80 tickets to cover $2,400. Sixty sold seats still means a $600 loss.",
      ...
      "consequences": {
        ...
        "threshold": "Each guest leaves $30 for the fixed bill. Eighty guests cover $2,400, with no cushion yet.",
        "cancel": "Cancelling avoids a known shortfall. The quote is still open, so you could wait for firm sales first.",
        "cheap": "Reducing fixed costs can work. Use a real quote, not a hoped-for saving."
      },
      "rubric": [
  ...
  },
  {
    ...
    "objective": "Grow the paying base without wasting acquisition cash.",
    "briefing": "Your team celebrates 100 new paid signups this month. Yet the total customer count barely moved. Next month you can spend $2,000 on one plan.",
    ...
    "evidence": [
      ...
      {
        "id": "opening-3",
        "label": "$20 to acquire one new user",
      ...
      },
      {
        ...
        "text": "Each active paid user leaves $15 before marketing and fixed overhead.",
        "kind": "simulation",
        "sourceIds": []
      },
      {
        ...
        "text": "Either repeat the signup campaign or investigate and fix the biggest cause of cancellations. The effect of a fix is not yet known.",
        "kind": "simulation",
        "sourceIds": []
      }
    ],
        ...
        "evidence": [
          {
            ...
            "text": "Forty departing users cite failed file imports. Others cite price or lack of use. Exit answers do not prove a fix would bring them back.",
            "kind": "simulation",
            "sourceIds": []
          }
        ]
        ...
        "evidence": [
          {
            ...
            "text": "The team can spend $2,000 on an import fix and a two-week test. The number of saved users remains unknown.",
            "kind": "simulation",
            "sourceIds": []
          }
        ]
        ...
        "evidence": [
          {
            ...
            "text": "Forty of those 100 left within three months. We do not know the same rate will repeat.",
            "kind": "simulation",
            "sourceIds": []
          }
        ]
    ...
    "options": [
      ...
      },
      {
        ...
        "description": "Use up to $2,000 to diagnose a cause and test a repair.",
        "tradeoff": "The repair may save few users, and new signups could slow."
      },
      {
        "id": "hold",
        "title": "Spend nothing this round",
        "description": "Keep the $2,000 cash while collecting free exit feedback.",
    ...
    "reveal": {
      ...
      "title": "The signup record that hides a leak",
      "history": "An authored practice case, not a historical company account. The celebrated month added only ten net users: 500 plus 100 minus 90 equals 510. Repair payback depends on how many users stay and for how long; no result is guaranteed.",
      "lesson": "New signups matter less when nearly as many people leave.",
      "sources": [],
      "consequences": {
        "ads": "New signups are real, but replacing departed users uses most of the effort. Repeat sales quality still needs checking.",
        "bigger": "More signups could grow the base, but this doubles an unproved long-term bet and creates a bill to repay.",
        "retain": "Ninety exits offset most of 100 signups. A measured repair addresses the leak instead of assuming it is harmless.",
