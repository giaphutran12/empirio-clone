...
export const puzzleCases44: CaseDefinition[] = [
  {
    ...
    reveal: {
      ...
      title: "The ad that sells at a loss",
      history:
        "An authored practice case, not a historical company account. At the opening rate, $4,000 sales minus $2,500 goods, $800 delivery and fees, and $1,000 ads leaves a $300 loss before overhead.",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        description:
          "Accept only after $15,000 clears, with signed balance terms.",
        tradeoff:
    ...
    reveal: {
      ...
      title: "The biggest customer in town",
      history:
        "An authored practice case, not a historical company account. The full order leaves $10,000 before overhead if paid. Yet the opening no-deposit plan needs $12,000 more than the $8,000 you can safely spend.",
      ...
      consequences: {
        ...
        deposit:
          "The deposit plus $8,000 spendable cash covers the $20,000 bill without touching the reserve.",
        decline:
          "Declining avoids a cash gap and more reliance on one customer. Asking for safe terms first could preserve the opportunity.",
        small:
          "Smaller goods cost less upfront, but delivery terms and buyer consent still need checking.",
      },
      rubric: [
  ...
  },
  {
    ...
    reveal: {
      ...
      consequences: {
        ...
        regular:
          "You protect the $8 contribution from each regular sale. You also give up a chance to bring back guests.",
        bundle:
  ...
  },
  {
    ...
    reveal: {
      ...
      consequences: {
        ...
        split:
          "Better payment timing could preserve the discount. Do not treat a request as agreed terms.",
      },
      rubric: [
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        description:
          "Limit revisions in writing and quote extra work separately.",
  ...
  },
  {
    ...
    reveal: {
      ...
      consequences: {
        ...
        cancel:
          "Cancelling avoids a known shortfall. The quote is still open, so you could wait for firm sales first.",
        cheap:
  ...
  },
  {
    ...
    reveal: {
      ...
      title: "The signup record that hides a leak",
      history:
        "An authored practice case, not a historical company account. The celebrated month added only ten net users: 500 plus 100 minus 90 equals 510. Repair payback depends on how many users stay and for how long; no result is guaranteed.",
      ...
      consequences: {
        ...
        bigger:
          "More signups could grow the base, but this doubles an unproved long-term bet and creates a bill to repay.",
        retain:
          "Ninety exits offset most of 100 signups. A measured repair addresses the leak instead of assuming it is harmless.",
