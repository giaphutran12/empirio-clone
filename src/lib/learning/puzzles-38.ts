...
export const puzzleLessons38: Record<string, CaseLesson> = {
  "case-038": {
    ...
    "history": {
      "decision": "Offer a smaller annual discount while keeping monthly billing available.",
      "result": "With all 100 customers staying for a year, monthly billing leaves $36,000 after stated costs. The $900 offer leaves only $6,000 before the supplier change.",
      "connection": "An annual payment changes when cash arrives. Its discount changes how much you earn for the same year of work.",
      "sources": []
    },
    "moneyComparison": {
    ...
    "alternativeConditions": "The $900 offer needs lower costs or better retention to offset its discount. At opening costs, $1,200 monthly terms break even at 50 customers staying all year; $900 annual terms need at least 86. No offer guarantees those buyers.",
    "check": {
      "question": "Ten customers choose $1,080 annual instead of paying $100 for all twelve months. How much sales income do you give up?",
      "answerId": "b",
      "options": [
        {
          "id": "a",
    ...
    "researchNotes": {
      ...
      "cancellations": "The full-year monthly comparison assumes all customers stay."
    },
    "eventChange": {
      "optionId": "cheap",
      "title": "Sell $900 years with higher service costs",
      "description": "A supplier change adds $10 per active customer per month to every plan. The $900 annual offer would still promise a full year of service.",
      "tradeoff": "Cash arrives first, but twelve months of service now cost more.",
  ...
  "case-039": {
    ...
    "history": {
      "decision": "Hold the original ad package and compare the fee income it would add.",
      "result": "Current orders produce $10,000 in platform fees, not $100,000 in platform sales. The original ad plan doubles order value but cuts the monthly amount left from $2,000 to $1,000.",
      "connection": "A campaign can grow the marketplace while shrinking what the platform keeps. Test growth against the added fee income.",
      "sources": []
    },
    "moneyComparison": {
      "title": "Compare the plans",
    ...
    "alternativeConditions": "At a 10% fee, each extra $100 order leaves $5 before fixed bills. The $6,000 campaign needs more than 1,200 extra orders to improve profit. A 12% fee at 900 orders leaves $3,300, if those sellers really stay.",
    "check": {
      "question": "The platform handles $200,000 of orders and takes a 10% fee. What is its fee income before costs?",
      "answerId": "c",
      "options": [
        {
          "id": "a",
        ...
        },
        {
          "id": "c",
          "text": "$20,000",
          "explanation": "$200,000 × 10% = $20,000. Service and other costs still need paying."
        }
      ]
    },
    "terms": [
    ...
    "researchNotes": {
      ...
      "repeat": "Repeat orders may help later, but do not count them as certain cash next month."
    },
    "eventChange": {
      "optionId": "ads",
      "title": "Buy the now-$12,000 ad package",
      "description": "The agency doubles its quote to $12,000 for the same target of 1,000 extra orders next month.",
  ...
  "case-040": {
    ...
    "history": {
      ...
      "result": "The current plan takes $10,000 at checkout but refunds $4,000. Its $6,000 net sales face $7,400 in costs. The guide’s unproved target would leave $300 in its first month.",
      "connection": "Checkout totals are not the end of a sale. Count the refunds and work that remain after a customer sends it back.",
      "sources": []
    },
    "moneyComparison": {
      "title": "Compare the plans",
    ...
    "alternativeConditions": "The guide needs no more than 22 returns out of 100 to avoid a loss in its first month at opening handling costs. With 23 returns, net sales are $7,700 and costs $7,730. A later month without the one-time guide cost differs.",
    "check": {
      "question": "100 orders pay $100 each. Thirty get full refunds. How much sales income remains before costs?",
      "answerId": "a",
      "options": [
        {
          "id": "a",
    ...
    "researchNotes": {
      "reasons": "Match the fix to the problem rather than buying a sales promise.",
      "guide": "Paying for a guide does not prove it will halve returns.",
      "supplier": "Small stock orders let you learn without buying another hundred units."
    },
    "eventChange": {
      "optionId": "repeat",
      "title": "Repeat with higher return handling",
      "description": "The carrier raises handling from $10 to $15 for each returned item next month. Keep the same 100-order plan and expected 40 returns.",
  ...
  "case-041": {
    ...
    "history": {
      "decision": "Fill normal machine time with basic items; price overtime separately.",
      "result": "Premium has the larger gain per item. Basic has the larger gain per machine hour. Original-price overtime adds $200; the higher quote instead cuts the result by $200.",
      "connection": "A bigger gain per item can be a smaller gain per scarce hour. Separate the product choice from the price of extra capacity.",
      "sources": []
    },
    "moneyComparison": {
      "title": "Compare the plans",
    ...
    "alternativeConditions": "Overtime improves this week’s result only below $800 for twenty extra hours. Premium would match basic’s $40 per hour if its $80 gain took two hours, but the proposed fixture is neither ready nor proven.",
    "check": {
      "question": "A product leaves $90 after direct costs and uses three machine hours. How much does it leave per hour?",
      "answerId": "b",
      "options": [
        {
          "id": "a",
        ...
        },
        {
          "id": "c",
          "text": "$270",
          "explanation": "Multiply hours to count usage, not to increase earnings."
        }
      ]
    },
    "terms": [
    ...
    "eventChange": {
      ...
      "description": "The overtime team raises the 20-hour charge from $600 to $1,000. Use all 80 hours for basic items.",
      "tradeoff": "The extra twenty basic sales leave only $800 before the overtime bill.",
  ...
  "case-042": {
    ...
    "history": {
      "decision": "Choose the six-job nearby route while the two-hour travel plan holds.",
      "result": "The short route doubles the daily amount left from $60 to $120 at opening travel times. Adding an expensive second crew instead reduces it to $40.",
      "connection": "A lower price can earn more when it cuts unpaid travel. If travel rises, check the route again rather than keeping an old conclusion.",
      "sources": []
    },
    "moneyComparison": {
      "title": "Compare the plans",
    ...
    "alternativeConditions": "The nearby $80 route needs six jobs to beat the current $60 result. Five leave only $50 after the full paid day and fixed bills. A second scattered route needs a lower crew quote or a higher price to improve the current result.",
    "check": {
      "question": "Five nearby jobs sell for $80 each. Labor is $200, supplies are $10 per job and fixed costs are $100. What remains?",
      "answerId": "c",
      "options": [
        {
          "id": "a",
    ...
    "researchNotes": {
      "route": "Dense routes work when access is planned, not just addresses nearby.",
    ...
    "eventChange": {
      ...
      "description": "A road closure raises total travel for the apartment route to four hours. Only four $80 jobs now fit in eight paid hours. Scattered routes are unaffected.",
  ...
  "case-043": {
    ...
    "history": {
      "decision": "Keep the current tools and seek weekday rentals before doubling the fleet.",
      "result": "Current use fills one third of capacity. At the target, the original campaign leaves $1,880 in monthly cash after stated bills, versus $1,080 without it. Buying tools with unchanged rentals leaves a $1,320 cash shortfall that month.",
      "connection": "Buying capacity is different from finding demand. Measure weekday and peak demand separately before making a lasting purchase.",
      "sources": []
    },
    "moneyComparison": {
      "basis": "cash",
    ...
    "alternativeConditions": "At the opening $240 campaign price, ten extra days cover the campaign because each adds $26 before ads. At $900, it needs 35 extra days. Buying tools may make sense for repeated peak demand, but one busy date is not a full-month forecast.",
    "check": {
      "question": "Eight tools can each rent for 30 days. You sell 60 tool-days. What share of capacity did you use?",
      "answerId": "a",
      "options": [
        {
          "id": "a",
          "text": "25%",
          "explanation": "Eight × 30 = 240 available days. 60 divided by 240 is one quarter."
        },
        {
          "id": "b",
          "text": "50%",
    ...
    "researchNotes": {
      ...
      "lease": "Eight fully sold rental days would leave $208 before that $80 lease fee."
    },
    "eventChange": {
      "optionId": "market",
      "title": "Buy the campaign at $900",
      "description": "The campaign quote rises from $240 to $900. Its target remains 40 extra paid tool-days at the normal $30 price.",
