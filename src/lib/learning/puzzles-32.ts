...
export const puzzleLessons32: Record<string, CaseLesson> = {
  "case-032": {
    ...
    choices: {
      ...
      target: {
        ...
        tradeoff:
          "You still need a way to limit coupons and a budget for setup.",
      },
      bundle: {
        score: 70,
    ...
    history: {
      decision:
        "Choose between more discounted cups and fewer full-price cups.",
      result:
        "At full price, $500 minus $400 leaves $100. At 150 discounted cups, $600 minus $500 also leaves $100. The new $50 fee lowers that to $50.",
      connection:
        "Check dollars left per cup, then multiply by a believable number of buyers.",
      sources: [],
    },
    moneyComparison: {
    ...
    check: {
      question:
        "At $4 per cup and $2 cost per cup, how many cups cover $200 of fixed costs?",
      answerId: "100",
      options: [
        {
          id: "50",
        ...
        },
        {
          ...
          text: "100 cups",
          explanation:
            "Each cup leaves $2. One hundred cups leave $200, so nothing is left after fixed costs.",
        },
        {
          id: "200",
          text: "200 cups",
          explanation:
            "Two hundred cups leave $400 before fixed costs, or $200 after them.",
        },
      ],
    },
    terms: [
    ...
    researchNotes: {
      demand:
        "A forecast is not a paid order. At 120 cups the discount leaves less money.",
      bundle:
  ...
  "case-033": {
    ...
    history: {
      decision:
        "Decide whether the bulk order deserves space already used by regular buyers.",
      result:
    ...
    check: {
      question:
        "One bulk pastry at $2 replaces a regular pastry at $4. Both cost $1. How much do you give up?",
      answerId: "2",
      options: [
        {
          id: "1",
          text: "$1",
          explanation:
            "That is what the bulk pastry leaves, not what you give up.",
        },
        {
          id: "2",
          text: "$2",
          explanation:
            "The regular pastry leaves $3; the bulk one leaves $1. You give up $2.",
        },
        {
          id: "4",
          text: "$4",
          explanation:
            "You still earn $2 from the bulk sale and its cost is the same.",
        },
      ],
    },
    terms: [
    ...
    eventChange: {
      ...
      tradeoff:
        "You earn more in this example but still turn away 200 regular buyers.",
  ...
  "case-034": {
    ...
    alternativeConditions:
      "Without the launch fee, the app can help if orders are extra and fit spare kitchen time. With the fee, more than 50 extra $20 app meals are needed to beat the direct-only night; the current kitchen has room for only 40.",
    choices: {
      all: {
        score: 75,
        verdict: "Reasonable move",
      ...
      discount: {
        ...
        tradeoff:
          "The kitchen has limited slots. Filling them cheaply can crowd out better sales.",
      },
    },
    history: {
      decision:
        "Decide whether extra delivery orders pay for the app’s fees and added work.",
      result:
    ...
    check: {
      question:
        "The app takes 30% of a $20 meal. Meal costs are $8 and packing $2. What remains before fixed costs?",
      answerId: "4",
      options: [
        {
          id: "14",
          text: "$14",
          explanation:
            "That is after the app fee but before meal and packing costs.",
        },
        {
          id: "4",
          text: "$4",
          explanation:
            "$20 minus $6 fee, $8 meal cost and $2 packing leaves $4.",
        },
        {
          id: "10",
          text: "$10",
          explanation:
            "This subtracts meal and packing but forgets the $6 app fee.",
        },
      ],
    },
    terms: [
    ...
    eventChange: {
      ...
      tradeoff:
        "Later nights may improve, but the first night earns less than direct-only sales.",
  ...
  "case-035": {
    ...
    choices: {
      all: {
        ...
        tradeoff:
          "Extra orders help only if they cover the shipping you now pay.",
      },
      threshold: {
        score: 65,
        verdict: "Reasonable move",
    ...
    history: {
      ...
      connection:
        "An extra dollar of sales is not an extra dollar available to pay for shipping.",
      sources: [],
    },
    moneyComparison: {
      title: "Compare the money",
    ...
    check: {
      question:
        "Goods keep 40% of their selling price before shipping. A buyer adds $10 to get $5 shipping free. How does money left change?",
      answerId: "down",
      options: [
        {
          id: "up",
          text: "Up $5",
          explanation:
            "The added goods do not all become earnings; 60% pays for the goods.",
        },
        {
          id: "same",
          text: "No change",
          explanation:
            "The added goods leave $4, which is $1 short of the lost $5 shipping charge.",
        },
        {
          id: "down",
          text: "Down $1",
          explanation:
            "The extra goods leave $4. Giving up $5 shipping means $1 less remains.",
        },
      ],
    },
    terms: [
  ...
  "case-036": {
    ...
    check: {
      question:
        "You start with $8,000, receive a $12,000 deposit and pay $12,000 delivery costs. What cash remains?",
      answerId: "8",
      options: [
        {
          id: "18",
  ...
  "case-037": {
    ...
    alternativeConditions:
      "A deposit can win if it protects missed slots without losing too many bookings or adding high fees. After the reminder price change, eight extra completed visits over four weeks cover the $300 fee and leave $20 extra.",
    choices: {
      deposit: {
        score: 75,
        verdict: "Reasonable move",
      ...
      double: {
        ...
        tradeoff:
          "A higher price may lose customers or change what they expect.",
      },
      hold: {
        score: 60,
        verdict: "Reasonable move",
    ...
    history: {
      decision:
        "Choose between reminders, deposits, a higher price and the current booking rules.",
      result:
        "The current plan leaves $700. Repeating the reminder trial would leave $880. Deposits with unchanged bookings and attendance would leave $800 after handling fees. None of those attendance assumptions is guaranteed.",
      connection:
        "Track completed visits and lost bookings together. Collecting money earlier does not always mean collecting more.",
      sources: [],
    },
    moneyComparison: {
      title: "Compare the money",
    ...
    check: {
      question:
        "A customer pays a $10 deposit toward a $50 visit, then shows up. What remains to pay?",
      answerId: "40",
      options: [
        {
          id: "40",
          text: "$40",
          explanation:
            "The $10 is part of the $50 total. It is not an extra fee.",
        },
        {
          id: "50",
          text: "$50",
          explanation:
            "That would make the total $60, turning the deposit into an added fee.",
        },
        {
          id: "60",
          text: "$60",
          explanation:
            "That would collect $70 including the deposit, above the stated price.",
        },
      ],
    },
    terms: [
    ...
    researchNotes: {
      buyers:
        "Fees can reduce bookings as well as no-shows. Test both numbers.",
      reminders:
        "Five extra visits leave $200 before the $20 service cost. Keep measuring.",
      admin:
        "Deposits are not free to handle. Count every booking fee, not just completed visits.",
    },
    eventChange: {
      optionId: "remind",
      ...
      tradeoff:
        "You commit more cash before knowing whether the effect will last.",
